...
| [200M v09a](https://huggingface.co/ShiningSon/Leviathan-MLGRU-200M-TinyStories-Instruct-v09a) | `leviathan_mlgru_200m_instruct_v09a` | 200M-class (~233.4M estimated) | MLGRU | Histogram Top-K `0.10`, down-only: 175.33 ms / 97.54 tok/s | 600/600 (100.0%) both modes | Leviathan v2 package, `engine.py --architecture mlgru` | Published current experimental candidate |
