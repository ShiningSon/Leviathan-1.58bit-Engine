...
This is a scaling probe, not a final model and not a general assistant. Do not upload v08a to Hugging Face, and do not claim general sparse speedup from v08a unless strict QA and measured throughput support it.
